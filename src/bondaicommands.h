...
#define isSubroutine(ID) ((ID == GAILIST_PLAY_IDLE_ANIMATION) |\
                            ...
                            IF(DEFINED(SETUPSUBROUTINES_PRESENT))\
                            (\
                                | SETUPSUBROUTINES(ID)\
                            ))\
...
#ifdef __GNUC__
#define AND_PAD(FAIL_LBL, \
             C0, V0, C1, V1, C2, V2, C3, V3, C4, V4, C5, V5, C6, V6, C7, V7, \
             C8, V8, C9, V9, CA, VA, CB, VB, CC, VC, CD, VD, CE, VE, CF, VF, ...) \
             AND_REAL(FAIL_LBL, \
             C0, V0, C1, V1, C2, V2, C3, V3, C4, V4, C5, V5, C6, V6, C7, V7, \
             C8, V8, C9, V9, CA, VA, CB, VB, CC, VC, CD, VD, CE, VE, CF, VF)

#define AND(FAIL_LBL, ...) AND_PAD(FAIL_LBL, __VA_ARGS__, \
             ,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,, )
#else
#define AND AND_REAL
#endif
