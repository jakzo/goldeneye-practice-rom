...
void proplvreset2(enum LEVELID stageId)
{
    ...
    if ((stageId <= (LEVELID_MAX + 1)) && setup_text_pointers[stageId])
    {
        ...
        sub_GAME_7F005540(numObjects);
        sub_GAME_7F005624(numAnimatedObjects);
                ...
                switch (phead->type)
                {
                    ...
                    case PROPDEF_AMMO:
                    {
                        ...
                        if (getPlayerCount() >= 2)
                        {
                            ...
                            slots[(mpweapon->ammotype - 1) * 2 + 1] = ammoqty;
                        }
                        ...
                        if (((ammoqty > 0) && withobjs) && (!(pdef_macr->flags2 & flags)))
                        {
                            ...
                            {
                                if ((slots[i9 * 2 + 1] > 0) && (slots[i9 * 2] != 0xFFFF))
                                {
                                    modelLoad(slots[i9 * 2]);
                                }
                            }
